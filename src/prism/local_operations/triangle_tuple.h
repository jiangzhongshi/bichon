...
namespace igl
{
  ...
  // on triangle meshes with triangle_triangle_adjacency.
  //
  // Note: this is **not** classical Half Edge data structure.
  //    Instead, it follows cell-tuple in [Brisson, 1989]
  //    "Representing geometric structures in d dimensions: topology and order."
  //    However, this class can achieve local navigation similar to half edge in OpenMesh
  ...
  //
  // Templates:
  //    DerivedF/FF/FFi Storage Type for F/FF/FFi. Support Matrix Type and std::vector<Vector> type. 
  // Inputs:
